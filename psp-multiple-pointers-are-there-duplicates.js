...
// Multiple Pointers - while variation
function areThereDuplicates(...args) {
  args.sort();    // to be able to use multiple pointers we need to sort the array first
...
// Multiple Pointers - for variation
function areThereDuplicates(...args) {
  args.sort();    // to be able to use multiple pointers we need to sort the array first

  for (let p1 = 0, p2 = 0; p2 < args.length; p1++, p2++) {
    if (args[p1] === args[p2]) return true;
  }
...
// Frequency counter variation with a early escape
